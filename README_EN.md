...
- **Transmittance Curve Plotting**: Visualize transmittance spectra
- **Multi-sample Comparison**: Compare transmittance data from different samples
...
1. Navigate to the "Transmittance Analysis" tab
2. Import transmittance data files
3. Visualize transmittance curves
...
### Transmittance Data Format
- CSV/TXT files with Wavelength (nm) and Transmittance (%) columns
